...
insert into Proyecto values(3,'Carpinteria','Londres');
insert into Proyecto values(2,'Techos','Londres');
insert into Proyecto values(5,'Construcción','Londres');
insert into Proyecto values(6,'Programación,'Londres');
