...
insert into provincias (nombre) values('Sevilla'),('Granada');
select * from clientes;

insert into clientes (nombre,domicilio,ciudad,codigoProvincia,telefono)  values ('Lopez Marcos', 'Colon 111', 'Córdoba',1,'null'); 
...
on provincias.codigo=clientes.codigoProvincia where codigoProvincia is null;
-- otra manera
select provincias.nombre from provincias where codigo not in(
