...
select nombre,TIMESTAMPDIFF(month, fechaNac,fechaFac) as anos_transcurridos 
from mascotas where fechaFac is not null;
-- arriba se puede poner month, day, year....
update mascotas set fechaFac='2000-05-13' where nombre='Kaiser';
-- ver que propietarios son duenos de perros
select dueno,especie from mascotas where especie like 'perro';
